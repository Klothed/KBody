...
Dics.prototype._setEvents = function () {
    ...
    var mouse_down_listener = function mouse_down_listener(event) {
      dics._mouse_down = true;
    }
    
    var update_slider = function update_slider(event)
    {
    ...
    var mouse_up_listener = function mouse_up_listener(event) {
      dics._mouse_down = false;
    ...
    dics.container.addEventListener('mousedown', mouse_down_listener);
    dics.container.addEventListener('mouseup', mouse_up_listener);
    dics.container.addEventListener('touchstart', mouse_down_listener);
    dics.container.addEventListener('touchend', mouse_up_listener);
    //dics.container.addEventListener('mousemove', listener);
